...
function searchBookmark() {
    for (var e, t = document.getElementById("searchbookmark").value.toUpperCase(), a = document.getElementById("chat-bookmark-list").getElementsByTagName("li"), s = 0; s < a.length; s++)
        -1 < ((e = a[s].getElementsByTagName("a")[0]).textContent || e.innerText).toUpperCase().indexOf(t) ? (a[s].style.display = "") : (a[s].style.display = "none");
}
...
function themeColor(e) {
    ...
    t && (document.getElementById(t).checked = !0),
        document.querySelectorAll(".theme-color").forEach(function (i) {
            ...
            a && ((a = a.id), (e = document.getElementsByClassName(a)), (t = window.getComputedStyle(e[0], null).getPropertyValue("background-color")), (rgbColorPrimary = t.substring(t.lastIndexOf("(") + 1, t.lastIndexOf(")")))),
                i.addEventListener("click", function (e) {
                    ...
                    ((a = window.getComputedStyle(t[0], null).getPropertyValue("background-color")),
                        (rgbColorPrimary = a.substring(a.lastIndexOf("(") + 1, a.lastIndexOf(")"))),
        ...
        document.querySelectorAll(".colorpicker-primary").forEach(function () {
            ...
            i.on("clear", function (e) {})
                ...
                .on("change", function (e, t, a) {
                    ...
                    (rgbColorsPrimary = s.substring(s.indexOf("(") + 1, s.lastIndexOf(","))),
...
!(function () {
    var f = !1,
        g = "users-chat",
        r = "assets/images/users/user-dummy-img.jpg",
        d = "users",
    ...
    e("users.json", function (e, t) {
        null !== e
            ...
            : (t[0].favorites.forEach(function (e, t) {
                var a = e.profile
                        ...
                        : '<div class="avatar-xs"><span class="avatar-title rounded-circle bg-primary text-white"><span class="username">' + e.nickname + '</span><span class="user-status"></span></span></div>',
                ...
                t[0].channels.forEach(function (e, t) {
                    var a = e.profile && e.profile,
                        ...
                        i = e.messagecount ? '<a href="javascript: void(0);" class="unread-msg-user">' : '<a href="javascript: void(0);">',
                        a = e.profile
                            ? '<img src="' + e.profile + '" class="rounded-circle avatar-xs" alt="">'
                            : '<div class="avatar-xs"><span class="avatar-title rounded-circle bg-primary text-white"><span class="username">' + e.nickname + "</span></span></div>";
        ...
        document.querySelectorAll("#favourite-users li, #usersList li").forEach(function (l) {
            l.addEventListener("click", function (e) {
                ...
                (document.querySelector(".user-profile-sidebar .user-name").innerHTML = a),
                    ...
                    (document.querySelector(".chat-input-typing .typing-user").innerHTML = a + ' is Typing<span class="typing ms-2"><span class="dot"></span><span class="dot"></span><span class="dot"></span></span>'),
                ...
                s
                    ...
                    : (document.querySelector(".user-own-img .avatar-sm").setAttribute("src", r),
                        document.querySelector(".user-profile-sidebar .profile-img").setAttribute("src", r),
                        document.querySelector(".audiocallModal .img-thumbnail").setAttribute("src", r),
                        document.querySelector(".videocallModal .videocallModal-bg").setAttribute("src", r));
            ...
            document.querySelectorAll("#channelList li").forEach(function (i) {
                i.addEventListener("click", function (e) {
                    ...
                    var s = document.getElementById(t).querySelector(".avatar-xs").getAttribute("src");
                    null !== s
                        ? (document.querySelector("#channel-chat .user-own-img .avatar-sm").setAttribute("src", s),
                            document.querySelector(".user-profile-sidebar .profile-img").setAttribute("src", s),
                            document.querySelector(".audiocallModal .img-thumbnail").setAttribute("src", s),
                            document.querySelector(".videocallModal .videocallModal-bg").setAttribute("src", s))
                        : (document.querySelector("#channel-chat .user-own-img .avatar-sm").setAttribute("src", r),
                            document.querySelector(".user-profile-sidebar .profile-img").setAttribute("src", r),
                            document.querySelector(".audiocallModal .img-thumbnail").setAttribute("src", r),
                            document.querySelector(".videocallModal .videocallModal-bg").setAttribute("src", r));
                });
            ...
            null !== e
                ...
                : ((callList = t),
                    callList.forEach(function (e, t) {
                        var a =
                                !0 === e.callVideo
                                    ? '<button type="button" class="btn btn-link p-0 fs-20 stretched-link" data-bs-toggle="modal" data-bs-target=".videocallModal"><i class="' + e.callTypeIcon + '"></i></button>'
                                    : '<button type="button" class="btn btn-link p-0 fs-20 stretched-link" data-bs-toggle="modal" data-bs-target=".audiocallModal"><i class="' + e.callTypeIcon + '"></i></button>',
                ...
                document.querySelectorAll("#callList li").forEach(function (i) {
                    i.addEventListener("click", function (e) {
                        ...
                        var s = document.getElementById(t).querySelector(".avatar-xs").getAttribute("src");
                        s
                            ? (document.querySelector(".audiocallModal .img-thumbnail").setAttribute("src", s), document.querySelector(".videocallModal .videocallModal-bg").setAttribute("src", s))
                            : (document.querySelector(".audiocallModal .img-thumbnail").setAttribute("src", r), document.querySelector(".videocallModal .videocallModal-bg").setAttribute("src", r));
                    });
                });
        }),
            ...
            null !== e
                ...
                : ((u = t).sort(function (e, t) {
                    ...
                    u.forEach(function (e, t) {
                        ...
                        l != e.name.charAt(0) && (document.getElementsByClassName("sort-contact")[0].innerHTML += s),
                            (document.getElementById("contact-sort-" + e.name.charAt(0)).innerHTML = document.getElementById("contact-sort-" + e.name.charAt(0)).innerHTML + i),
                            (l = e.name.charAt(0));
                    })),
                document.querySelectorAll(".sort-contact ul li").forEach(function (s) {
                    s.addEventListener("click", function (e) {
                        ...
                        (document.querySelector(".text-truncate .user-profile-show").innerHTML = t),
                            ...
                            (document.querySelector(".chat-input-typing").style.display = "block"),
                            (document.querySelector(".user-profile-status").style.display = "block"),
                            (document.querySelector(".chat-input-typing .typing-user").innerHTML = t + ' is Typing<span class="typing ms-2"><span class="dot"></span><span class="dot"></span><span class="dot"></span></span>');
            ...
            ? (v.classList.add("show"),
                ...
                null != u
                    ? (v.classList.remove("show"),
                        (t = r),
                        (a = B),
                        (s = document.getElementById(t).querySelector(".chat-conversation-list")),
                        (i = ""),
                        a.forEach(function (e) {
                            i +=
                                    ...
                                    i.querySelectorAll(".download-file").forEach(function (i) {
                                        i.addEventListener("click", function (e) {
                                            ...
                                            window.File && window.FileReader && window.FileList && window.Blob
                                                ? ((t = new Blob([j[s]], { type: "application/pdf" })), ((a = document.createElement("a")).href = window.URL.createObjectURL(t)), (a.download = j[s].name), a.click())
                                    ...
                                    document.querySelectorAll(".download-file").forEach(function (i) {
                                        i.addEventListener("click", function (e) {
                                            ...
                                            var t,
                                                ...
                                                s = i.getAttribute("data-id");
                                            window.File && window.FileReader && window.FileList && window.Blob
                                                ? ((t = new Blob([j[s]], { type: "application/mp3" })), ((a = document.createElement("a")).href = window.URL.createObjectURL(t)), (a.download = E[s].name), a.click())
                                                : alert("The File APIs are not fully supported in this browser.");
                                        });
                                    }),
                                    document.querySelector(".file_Upload ").classList.remove("show");
            ...
            : 1 == f
                ? ((function (e, t) {
                    ...
                    l.querySelectorAll(".delete-item").forEach(function (e) {
                        ...
                        l.querySelectorAll(".copy-message").forEach(function (e) {
                            e.addEventListener("click", function () {
                                l.childNodes[1].children[1].firstElementChild.firstElementChild.getAttribute("id"),
                                    (isText = l.childNodes[1].children[1].firstElementChild.firstElementChild.innerText),
                        ...
                        s.querySelectorAll(".reply-message").forEach(function (i) {
                            i.addEventListener("click", function () {
                                ...
                                (f = !0),
                                    ...
                                    (document.querySelector(".replyCard .replymessage-block .flex-grow-1 .mb-0").innerText = a),
                                    (document.querySelector(".replyCard .replymessage-block .flex-grow-1 .conversation-name").innerText = s);
                            });
                        }),
                        s.querySelectorAll(".copy-message").forEach(function (e) {
                            e.addEventListener("click", function () {
    ...
    function I(e, t, a, s, i, l, r) {
        ...
        if (null != t) o += '<div class="ctext-wrap-content" id=' + e + '>        <p class="mb-0 ctext-content">' + t + "</p></div>";
        else if (a && 0 < a.length) {
            for (o += '<div class="message-img mb-0">', M = 0; M < a.length; M++)
                o +=
                    '<div class="message-img-list">            <div>              <a class="popup-img d-inline-block" href="' +
                    a[M] +
                    '">                <img src="' +
        ...
        (t = e),
            (a = function (e, t) {
                ...
                null !== e
                    ...
                    : ((l = "users" == d ? t[0].chats : t[0].channel_chat),
                        ...
                        l.forEach(function (t, e) {
                            ...
                            0 < r
                                ...
                                m != t.from_id && (i += '<div class="chat-avatar"><img src="' + s.profile + '" alt=""></div>'),
                                    (i += '<div class="user-chat-content">'),
                                    (i += I(t.id, t.msg, t.has_images, t.has_files, t.has_audios, t.has_videos, t.has_dropDown)),
                                l[e + 1] &&
                                ...
                                ((r = (function (e, t, a) {
                                    ...
                                    (i += (function (e, t, a) {
                                        for (var s = 0; e[t] && e[t + 1] && e[t + 1].from_id == a; )
                                            (s = I(e[t + 1].id, e[t + 1].msg, e[t + 1].has_images, e[t + 1].has_files, e[t + 1].has_audios, e[t + 1].has_videos, e[t + 1].has_dropDown)), t++;
                                        return s;
                                    })(l, e, t.from_id))),
                                    (i += '<div class="conversation-name"><small class="text-muted time">' + t.datetime + '</small> <span class="text-success check-message-icon"><i class="bx bx-check-double"></i></span></div>'),
                                    (i += "</div>                </div>            </li>"),
                                    (document.getElementById(d + "-conversation").innerHTML += i));
                        })),
                    ...
                    (s = C.querySelectorAll(".reply-message")),
